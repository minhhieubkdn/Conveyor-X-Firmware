...
// bool led_stt = false;
// bool invert_encoder_dir = false;
// bool invert_stepper_dir = false;
...
//   attachInterrupt(digitalPinToInterrupt(ENCODER_PIN_A), intterupt_a, CHANGE);
// }

// void intterupt_a()
// {
//   if (READ(ENCODER_PIN_B))
//   {
//     if (READ(ENCODER_PIN_A))
//     {
//       absolute_pulse--;
//     }
//     else
...
//   get(DEFAULT_PULSE_PER_MM, pulse_per_mm);
//   delay(100);
// }
...
//   if (millis() - LedBlinkMillis > STEPPER_COMPARE_VALUE_TIMER / 16)
//   {
...
//   DesireStepPosition += roundf(DesirePosition * DEFAULT_STEP_PER_MM);
//   DesirePosition = 0;
...
//     if (abs(speed) < DEFAULT_MAX_SPEED)
//     {
//       DesireSpeed = speed;
//       DesirePosition = 0;
//       COMMAND_PORT.println("Ok");
...
//       put(DEFAULT_PULSE_PER_MM, pulse_per_mm);
//       COMMAND_PORT.println("Ok");
//     }
//   }
